...
inline std::vector   <LightSource> LightSources;
inline std::vector    <SceneLayer> SceneLayers;
...
public:
	...
	glm::vec2 WindowMousePosition = {0.0f,0.0f};
...
inline std::map<int,Window> Windows;
